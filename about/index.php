...
?>
    <div class="row">
        <div class="col-xs-12">
            ...
            <p>На данный момент мы представляем собой крупную компанию, владеющую интернет&ndash;магазином и имеющую в
                своей сети единый call-центр, который регулирует всю деятельность магазина, отдел продаж, службу
                доставки, широкий штат квалифицированных сборщиков, собственный склад c постоянным наличием необходимого
                запаса товаров.</p>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <ul class="bxe-list bxe-lis-blue">
                        ...
                        <li><i class="fa fa-check"></i> <span style="font-size:13px;">Профессиональный менеджеры</span>
                        </li>
                ...
                <div class="col-xs-4">
                    <ul class="bxe-list bxe-lis-blue">
                        ...
                        <li><i class="fa fa-check"></i> <span style="font-size:13px;">Карты постоянных клиентов</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <p>Мы всегда рады общению с нашими клиентами. Если у вас есть какие-либо пожелания, предложения, замечания,
                ...
                внимание:</p>
            <p><b>Электронная почта</b>: <a href="mailto:sale@skillbox.tw1.ru">sale@skillbox.tw1.ru</a></p>
        </div>
    </div>
